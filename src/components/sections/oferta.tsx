...
export function OfertaSection() {
  return (
    <section className="flex flex-col items-center text-center bg-black text-white py-16 px-6 rounded-2xl border-2 border-primary/30 shadow-2xl shadow-primary/10">
      <div className="max-w-md mx-auto">
        ...
        <Button 
          size="lg" 
          className="mt-10 w-full h-16 bg-primary text-primary-foreground text-xl font-bold rounded-full transition-all duration-300 ease-in-out hover:bg-primary/90 hover:shadow-[0_0_25px_hsl(var(--primary))] shadow-[0_0_15px_hsl(var(--primary))] border-2 border-primary/50"
        >
